...
if __name__ == "__main__":
    ...
    parser.add_argument('--type-id', help="Leaf type ID. This must be created in your project", type=int, required=True)
    ...
    url_auto_complete = f"{host}/rest/Leaves/Suggestion/{project_name}.{label_tree_dict['name']}/{project}"
