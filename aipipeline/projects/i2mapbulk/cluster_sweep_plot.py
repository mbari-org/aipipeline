...
root_dir = '/mnt/ML_SCRATCH/i2mapbulk/clusters/Unknown'
total_clusters = []
cluster_coverages = []
annotations = []
models = []
...
# Plotting with color gradient based on min_cluster_size
plt.figure(figsize=(14, 8))
scatter = plt.scatter(
    total_clusters,
    cluster_coverages,
    c=mcs_v,           # Use min_cluster_size for color gradient
    s=dot_sizes,
    cmap='viridis',
    alpha=0.7
)
...
# Add colorbar for min_cluster_size
cbar = plt.colorbar(scatter)
cbar.set_label('min_cluster_size', fontsize=16)
plt.tight_layout()

# Save figure
output_path = "cluster_vs_coverage_with_params_i2MAP.png"
