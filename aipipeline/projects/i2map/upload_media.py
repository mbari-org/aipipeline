# Utility script to load i2MAP video into Tator
# Run with python upload_media.py --host http://i2map.shore.mbari.org --token <token> --type-id <type_id> --media-path <path_to_media>
import logging
import sys
import time
