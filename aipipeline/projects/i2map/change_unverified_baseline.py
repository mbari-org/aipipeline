...
kwargs = {}
project = 3  # project in the database
box_type = 3  # box type in the database
version = 3
...
kwargs["attribute"] = ["verified::False", "group::NMS", "generator::vars-labelbot"]
...
for start in range(0, count, 500):
    ...
    id_bulk_patch = {
        "attributes": {"score": 0.0, "Label": "Unknown"},
